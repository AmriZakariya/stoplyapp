...
public class Main extends AppCompatActivity {
    ...
    Button showselectedAppsButton;
    CircularSeekBar seekBar;
    CircularSeekBar mCircularSeekBar;
    String hours_selector_String = "55_hour";
...
//        BottomNavigationView.OnNavigationItemSelectedListener()
    ...
    public void init() {
        ...
        TimePicker picker1 = (TimePicker) findViewById(R.id.timePicker1);
        picker1.setIs24HourView(true);
//        picker1.setAccessibilityPaneTitle(true);
        ...
        showselectedAppsButton = findViewById(R.id.showSelectedAppsButton);
...
//        Checking if the lock is running or not
    ...
    public void selection_all() {
        ...
        hours_selector.setVisibility(View.GONE);
        counter_selector.setVisibility(View.GONE);
        ...
        seekBar.setOnRoundedSeekChangeListener(new OnCircularSeekBarChangeListener() {
            ...
            public void onProgressChange(CircularSeekBar CircularSeekBar, float progress) {
                ...
                int minutes = t % 60;
                seekBar.setText(hours+"h "+minutes+"min");

                if(hours < 1){
                    hours_selector_String = minutes+"_hour" ;
                }else if(hours == 1 || hours == 2 | hours == 3 ){
                    hours_selector_String = hours+"_hour" ;
                }else{
                    hours_selector_String = ( hours * 60 )+""+minutes+"_hour" ;
                }
...
//        int t = (int) seekBar.getProgress() ;
//        t *= 3 ;
//        int hours = t / 60; //since both are ints, you get an int
//        int minutes = t % 60;
//        if(hours < 1){
//            hours_selector.selectItemWithValue(minutes+"_hour");
//        }else if(hours == 1){
//            hours_selector.selectItemWithValue("1_hour");
//        }else{
//            hours_selector.selectItemWithValue(hours+""+minutes+"_hour");
//        }

        Log.d("azerazer",hours_selector.getSelectedItem().value);

//        final SwipeSelector hours_selector = new SwipeSelector();
//        final SwipeSelector counter_selector = findViewById(R.id.counter_selector);
...
//        }
        ...
        counter_selector.selectItemWithValue("1");
            ...
            public void onClick(View v) {
                ...
                if (db.get_Running(1).equals("N")) {
                    if (db.get_Selected(1) == 1) {
                        if (hours_selector.hasSelection() || true) {
                            new LovelyStandardDialog(Main.this)
                                    .setTopColorRes(R.color.blue)
...
//                                                    start_timer(h_value);
                                                    start_timer(hours_selector_String);
                                                    db.set_LockTime(hours_selector_String);
                                                    toastMessage += getString(R.string.hours) + seekBar.getText();
...
//                                                    }
        ...
        showselectedAppsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Main.this, selected_apps.class);
                startActivity(intent);
...
//        Intent i = new Intent(Main.this, StoplyService.class);
//        startService(i);

//        Intent stoply_service = new Intent(getApplicationContext(), Timer_Service.class);
//        startService(intent_service);
    }
