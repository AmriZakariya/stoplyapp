...
//                PendingIntent.getActivity(this, 0, intent, 0);
        ...
        pendingIntent = PendingIntent.getService(getApplicationContext(), 1, lockIntent, PendingIntent.FLAG_ONE_SHOT);
...
//        lockIntent.addFlags(Intent.FLAG_RECEIVER_FOREGROUND);
    ...
    public String twoDatesBetweenTime() {
        ...
        try {
            ...
            int int_hours ;
            try {
                int_hours = Integer.parseInt(db.get_Hours(1));
            ...
            if (long_hours >= 0) {
                ...
                Log.d("twoDatesBetweenTime", "long_hours positif: ");

                str_testing = String.format("%d:%d:%02d", diffHours2, diffMinutes2, diffSeconds2);
                Log.e("TIME", "TIMETIMETIME "+str_testing);
                ...
                Log.d("twoDatesBetweenTime", "long_hours close: ");
            ...
            Log.d("twoDatesBetweenTime", "Exceptionnn: "+ e);
...
//        Log.e("LockApps()", "Disabled");

        if ((int) db.getAppsCount() != 0) {
            int count = (int) db.getAppsCount();
            for (int i = 1; i <= count; ++i) {
                Log.e("LockApps() For ", "db.get_app_PKG(i)"+ db.get_app_PKG(i));

                if (printForegroundTask().equalsIgnoreCase(db.get_app_PKG(i))) {
                    Log.e("LockApps() For Kill ", "db.get_app_PKG(i) = "+ db.get_app_PKG(i));
//                    ActivityManager manager = (ActivityManager)getSystemService(Activity.Ac);
//                    if (manager != null) {
//                        Log.e("KILLKILLL", "KILLKILLL");
//
...
//                    Intent dialogIntent = new Intent(getBaseContext(), locked.class);
